...
class main_frame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.segemented_button = ctk.CTkSegmentedButton(self.left_frame, values= list_segmented, variable= self.segmented_var)
        ...
        self.slider2 = ctk.CTkSlider(self.right_frame, from_= 0, to= 1, number_of_steps= 100, variable= self.progress_var2, orientation= 'vertical')
        ...
        self.check1 = ctk.CTkCheckBox(self.checkbox_frame, text= 'CTkCheckBox', onvalue= 1, offvalue= 0, variable= check_var)
